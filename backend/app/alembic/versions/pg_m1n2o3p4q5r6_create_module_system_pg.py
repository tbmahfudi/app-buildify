"""Create module system tables (PostgreSQL)"""
from alembic import op
import sqlalchemy as sa
from sqlalchemy.dialects import postgresql

revision = "pg_m1n2o3p4q5r6"
down_revision = "pg_h2i3j4k5l6m7"  # Update this to the latest migration
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        # Configuration
        sa.Column('manifest', postgresql.JSON, nullable=False),
        ...
        sa.Column('database_tables', postgresql.JSON, nullable=True),
    ...
    op.create_table(
        ...
        # Usage tracking
        sa.Column('usage_count', postgresql.JSON, nullable=True),
