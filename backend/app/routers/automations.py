...
async def create_automation_rule(
    rule: AutomationRuleCreate, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def get_automation_rule(rule_id: UUID, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
async def update_automation_rule(
    rule_id: UUID, rule: AutomationRuleUpdate, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def delete_automation_rule(rule_id: UUID, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
async def toggle_automation_rule(rule_id: UUID, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
async def execute_automation_rule(
    rule_id: UUID, context_data: dict = {}, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def get_automation_execution(
    execution_id: UUID, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def list_action_templates(db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
async def create_webhook_config(
    webhook: WebhookConfigCreate, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def list_webhook_configs(
    webhook_type: Optional[str] = Query(None), db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def get_webhook_config(webhook_id: UUID, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
async def delete_webhook_config(
    webhook_id: UUID, db: Session = Depends(get_db), current_user=Depends(get_current_user)
):
