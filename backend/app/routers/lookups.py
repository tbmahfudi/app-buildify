...
from app.schemas.lookup import LookupConfigurationResponse
...
async def list_lookup_configurations(
    ...
    """List all lookup configurations - Stub implementation"""
    return []
...
async def get_lookup_configuration(
    ...
    """Get lookup configuration - Stub implementation"""
