...
SEED_DATA = {
    ...
    "tech_startup": {
        ...
        "branches": [{"code": "HQ", "name": "San Francisco HQ", "description": "Main office and only location"}],
        "departments": [
    ...
    "retail_chain": {
        ...
        "users": [
            ...
            {
                "email": "sales.nyc1@fashionhub.com",
                "name": "NYC Sales Rep",
                "is_superuser": False,
                "dept": "SALES",
                "branch": "NYC-01",
