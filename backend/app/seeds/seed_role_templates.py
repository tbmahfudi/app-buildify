...
def seed_role_templates():
    ...
    try:
        ...
        role_templates = [
            ...
            },
            {
                ...
                "permissions": [
                    ...
                    "users:read_roles:tenant",
                    "users:read_permissions:tenant",
                    ...
                    "dashboards:delete:tenant",
                    "dashboards:clone:tenant",
                    "dashboards:share:tenant",
                    "dashboards:snapshot:tenant",
                    "dashboards:export:tenant",
                    "dashboards:create_page:tenant",
                    "dashboards:create_widget:tenant",
                    # Report Management
                    "reports:read:tenant",
                    ...
                    "reports:schedule:create:tenant",
                    "reports:schedule:read:tenant",
                    "reports:schedule:update:tenant",
                    "reports:schedule:delete:tenant",
                    "reports:templates:read:tenant",
                    "reports:templates:create:tenant",
                    "reports:templates:update:tenant",
                    "reports:templates:delete:tenant",
                    # Scheduler Management
                    "scheduler:config:read:tenant",
                    "scheduler:config:create:tenant",
                    "scheduler:config:update:tenant",
                    "scheduler:config:delete:tenant",
                    "scheduler:jobs:read:tenant",
                    "scheduler:jobs:create:tenant",
                    "scheduler:jobs:update:tenant",
                    "scheduler:jobs:delete:tenant",
                    "scheduler:jobs:execute:tenant",
                    "scheduler:executions:read:tenant",
                    "scheduler:executions:cancel:tenant",
                    # Audit & Monitoring
                    "audit:read:tenant",
                    "audit:summary:read:tenant",
                    "audit:export:tenant",
                    ...
                    "settings:branding:read:tenant",
                    "settings:branding:update:tenant",
                    "settings:integration:read:tenant",
                    "settings:integration:update:tenant",
                    "settings:api_keys:read:tenant",
                    "settings:api_keys:create:tenant",
                    "settings:api_keys:revoke:tenant",
                    "settings:api_keys:delete:tenant",
                    "settings:email:read:tenant",
                    "settings:email:update:tenant",
                    "settings:email:test:tenant",
                    "settings:sms:read:tenant",
                    "settings:sms:update:tenant",
                    "settings:sms:test:tenant",
                    # Metadata Management
                    "metadata:read:tenant",
                    "metadata:create:tenant",
                    "metadata:update:tenant",
                    "metadata:delete:tenant",
                    "metadata:schema:design:tenant",
                    "metadata:schema:deploy:tenant",
                    "metadata:schema:export:tenant",
                    "metadata:fields:create:tenant",
                    "metadata:fields:update:tenant",
                    "metadata:fields:delete:tenant",
                ],
            },
            {
            ...
            },
            {
                ...
                "permissions": [
                    ...
                    "dashboards:export:tenant",
                    "dashboards:create_page:tenant",
                    "dashboards:update_page:own",
                    "dashboards:delete_page:own",
                    "dashboards:create_widget:tenant",
                    "dashboards:update_widget:own",
                    "dashboards:delete_widget:own",
                    # Analytics
                    "analytics:read:tenant",
                    "analytics:export:tenant",
            ...
            },
            {
                ...
                "permissions": [
                    ...
                    "reports:read:tenant",
                    "reports:execute:own",
                    "reports:history:read:own",
                    # View own data
                    "audit:read:own",
                    "api_activity:read:own",
                    # Personal settings
                    "settings:read:own",
                    "settings:update:own",
                ],
        ...
        print(f"\n{'='*60}")
        print("Role Templates Seed Complete")
        print(f"{'='*60}")
