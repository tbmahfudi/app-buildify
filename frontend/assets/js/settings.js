...
// Also listen for route changes to the User Settings page.
// (Legacy 'settings' route is redirected to 'settings/user' by app.js.)
document.addEventListener('route:loaded', (event) => {
  if (event.detail.route === 'settings/user') {
...
async function initSettingsPage() {
  ...
  // NOTE: tenant/company configuration lives on the Admin Settings page
  // (route settings/admin, settings-admin.js), not here.
}
