# App-Buildify — Platform Backlog

> **Scope**: Platform epics only. Module-specific backlogs live in their own `plan-mod-<name>/` folders (e.g. [Financial Module](../plan-mod-finance/BACKLOG.md)).
