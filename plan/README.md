...
├── PIPELINE.md        ← aggregated artifact status (auto-generated by scripts/regen-pipeline.py)
...
| 4 | [RBAC & Permissions](epics/epic-04-rbac-permissions.md) | 7 | DONE — core complete (epic-21 sprint 1 retired role CRUD + wildcards + entity perms) |
...
| 23 | [Module Lifecycle & Activation](epics/epic-23-module-lifecycle-and-activation.md) | 9 (across 5 features) | OPEN — developer packaging pipeline (`manage.sh module pack/install`) + tenant self-service activate/deactivate; gated by API contract alignment (story 23.1.1) |
